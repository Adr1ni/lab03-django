# Generated by Django 4.1 on 2023-09-14 00:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tarea.categoria')),
            ],
        ),
        migrations.CreateModel(
            name='Telefono',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direccion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tarea.direccion')),
            ],
        ),
        migrations.AddField(
            model_name='producto',
            name='proveedor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tarea.proveedor'),
        ),
        migrations.AddField(
            model_name='cliente',
            name='direccion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tarea.direccion'),
        ),
        migrations.AddField(
            model_name='cliente',
            name='telefonos',
